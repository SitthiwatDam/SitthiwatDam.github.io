...
const techStack = [
  ...
  // },
  {
    ...
    langName: "SQL",
    langDesc: "<li>SQL (Structured Query Language) is a domain-specific language used to manage and manipulate relational databases by querying, inserting, updating, and deleting data.</li>",
  },
];
